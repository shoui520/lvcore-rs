...
use super::lved_refs::{
    ...
    lved_cross_book_target, lved_dataid_anchor, lved_dataid_target, lved_dict_info_target,
    lved_external_viewer_image_path, lved_external_viewer_image_ref,
...
use super::ssed_search_runtime::{
    ...
    SSED_FULLTEXT_SCAN_WINDOW_BYTES, SSED_FULLTEXT_TITLE_CURSOR_PREFILTERED_LEAF_PAGE_BUDGET,
    SSED_PARTIAL_INDEX_PREFILTERED_LEAF_PAGE_BUDGET, SSED_PARTIAL_INDEX_SCAN_LEAF_PAGE_BUDGET,
    SsedFulltextRow, SsedIndexSearchCollector, SsedNearKeyScanResult, SsedPartialIndexScanCursor,
...
pub struct ReaderBookPackage {
    ...
    ssed_ios_table_list_cross_book_owners: Mutex<BTreeMap<String, Option<(String, String)>>>,
...
impl ReaderBookPackage {
    pub(crate) fn new(
        ...
        let retained_ios_search_payloads = stores
            ...
            .unwrap_or_default();
        let retained_ios_convert_addr_payloads = stores
            .retained_ios_dictlist
            .as_ref()
            .map(|info| info.convert_addr_payloads.clone())
            .unwrap_or_default();
        Self {
            ...
            ssed_ios_table_list_cross_book_owners: Mutex::new(BTreeMap::new()),

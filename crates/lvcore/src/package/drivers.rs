...
impl ReaderBookPackage {
    ...
    fn scan_ssed_index_component_rows(
        &self,
        component: &SsedComponent,
        row_limit: Option<usize>,
        mut on_row: impl FnMut(SsedIndexRow) -> Result<bool>,
...
fn ssed_multi_selector_records_to_nodes(
    package: &ReaderBookPackage,
    descriptor_name: &str,
    record_index: u16,
    records: &[SsedMenuRecord],
...
fn parse_ssed_multi_surface_id(surface_id: &str) -> Option<SsedMultiSurfaceId> {
...
fn ssed_multi_root_surface_id(descriptor_name: &str) -> String {
    format!("multi:{descriptor_name}")
}

fn ssed_multi_record_surface_id(
    descriptor_name: &str,
    record_index: u16,
    filter: Option<&str>,
) -> String {
...
fn ssed_multi_record_menu_ref(record: &SsedMultiRecord) -> Option<&SsedMultiComponentRef> {
    record
        .refs
        .iter()
...
fn ssed_multi_record_index_ref(record: &SsedMultiRecord) -> Option<&SsedMultiComponentRef> {
    record
        .refs
        .iter()

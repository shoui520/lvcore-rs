    ...
    connection
        .execute_batch(
            ...
            insert into t_contents values
              (1, '<b>まえがき</b>', '<article><h1>まえがき</h1><p>body</p><a href="lved_ref:entry:000003">next</a><a href="lved.dataid:000002">dataid next</a><a name="000004"></a><a href="lved.dataid:000004">local anchor</a><img src="pic.png"><img src="javascript:bad()"><object data="file:///tmp/outside.bin"></object><img src="lvcore://resource/already-normalized"></article>');
            insert into t_contents values
